    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="p-5 border rounded-2xl space-y-4" style={{ background: c.cardBg, borderColor: c.border }}>
          ...
          {billingOfferMsg && (
            <p className="text-xs font-semibold" style={{ color: billingOfferMsg.startsWith("❌") ? c.red : c.green }}>
              {billingOfferMsg}
            </p>
          )}

          <h3 className="text-sm font-bold pt-2" style={{ color: c.primary }}>Saved Payment Method</h3>
          <div className="p-3 border rounded-xl flex items-center justify-between text-xs" style={{ borderColor: c.border }}>
      ...
      <div className="p-5 border rounded-2xl space-y-4" style={{ background: c.cardBg, borderColor: c.border }}>
        ...
        <div className="space-y-2 text-sm leading-relaxed">
          {[
            ...
            <div key={inv.id} className="flex justify-between items-center p-3 border rounded-xl" style={{ borderColor: c.border }}>
              <div>
